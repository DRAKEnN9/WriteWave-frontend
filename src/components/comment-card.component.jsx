...
const CommentCard = ({index, leftVal, commentData}) => {
    ...
    const LoadMoreRepliesButton = () =>{
        ...
        const parentIndexExists = parentIndex !== undefined && parentIndex !== null; // Ensure parentIndex is valid

        let button = <button onClick={( ) => loadReplies({ skip: index - parentIndex, currentIndex: parentIndex })} 
        className="text-dark-grey p-2 px-3 hover:bg-grey rounded-md flex items-center gap-2">Load More Replies</button>;
    ...
    return (
        <div className="w-full" style={{ paddingLeft: `${leftVal * 10}px`}}>
            <div className="my-6 p-6 rounded-md border border-grey">
                ...
                <p className="font-galasio text-xl ml-3">{comment}</p>
