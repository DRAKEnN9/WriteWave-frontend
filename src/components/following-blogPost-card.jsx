...
const FollowingBlogPostCard = ({content, author}) =>{
    
    let { publishedAt, tags = [], title, des, banner, activity: { total_likes = 0 } = {}, blog_id: id } = content;
...
export default FollowingBlogPostCard;