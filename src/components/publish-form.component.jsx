        ...
        <AnimationWrapper>
            <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4">
                ...
                <div className="max-w-[550px] center">
                    ...
                    <p className="font-helasio line-clamp-2 text-xl leading-7 mt-4"> { des } </p>
                </div>

                <div className="border-grey lg:border-1 lg:pl-8">
                    <p className="text-dark-grey mb-2 mt-9">Blog Title</p>
                    <input type="text" placeholder="Blog Title" defaultValue={title} 
                    className="input-box pl-4" onChange={handleBlogTitleChange}/>
                    ...
                    <div className="relative input-box pl-2 py-2 pb-4">
                        <input type="text" placeholder="Topics" className="sickey input-box bg-white top-0 left-0 pl-4 mb-3 focus:bg-white" 
                    ...
                    />
                        ...
                        <p className="mt-1 mb-4 text-dark-grey text-right">{ tagLimit - tags.length } Tag left</p>
